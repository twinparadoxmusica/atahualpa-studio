...
export const translations = {
  fr: {
    ...
    'nav.branch.music.kicker': 'MUSIQUE',
    'nav.branch.music.label': 'Cours de musique',
    'nav.branch.av.kicker': 'AUDIOVISUEL',
    'nav.branch.av.label': 'Enregistrement / streaming',
    'nav.branch.acoustic.kicker': 'ACOUSTIQUE',
    'nav.branch.acoustic.label': 'Isolation / traitement',
    ...
    'nav.openLecons': 'Ouvrir le menu Cours de musique',
    ...
    'lecons.hero.lede': 'Une approche structurée et personnalisée, adaptée aux goûts, au rythme et aux objectifs de chaque élève — pour apprendre, créer et trouver sa propre voix.',
    ...
    'group.cta': 'Demander un cours d’essai gratuit sur WhatsApp',
    'group.cta.note': 'Nous vous proposerons le créneau le plus adapté selon l’âge de l’enfant, son niveau et les groupes disponibles.',
    'group.pricing.title': 'Nos formules — cours en groupe',
    'group.pricing.lede': 'Des formules claires pour s’adapter au calendrier de votre enfant et à la continuité de son parcours.',
    'group.pricing.note': 'Les formules régulières sont mises en place après confirmation du créneau avec le studio.',
    'group.offer.trial.tag': '🎶✨',
    'group.offer.trial.title': 'Cours d’essai gratuit',
    'group.offer.trial.price': '0 CHF',
    'group.offer.trial.cta': 'Demander un cours d’essai gratuit',
    'group.offer.monthly.tag': '👧👦',
    'group.offer.monthly.title': 'Formule mensuelle flexible',
    'group.offer.monthly.price': '70 CHF / séance',
    'group.offer.monthly.subPrice': 'Montant selon les séances confirmées',
    'group.offer.monthly.cta': 'Choisir la formule mensuelle',
    'group.offer.annual.tag': '🧭 Continuité pédagogique',
    'group.offer.annual.title': 'Inscription régulière',
    'group.offer.annual.price': '60 CHF / séance',
    'group.offer.annual.subPrice': 'Engagement année scolaire',
    'group.offer.annual.cta': 'Choisir l’inscription régulière',

    // Summer camp (holiday version of the group workshop)
    'camp.badge': 'Stage vacances · Enfants',
    'camp.title': 'Stage d’été multi-instrumental',
    'camp.card1.title': 'Plusieurs instruments',
    'camp.card1.body': 'Les enfants changent d’instrument et développent une vision globale de la musique.',
    'camp.card2.title': 'Création en groupe',
    'camp.card2.body': 'Ils jouent ensemble, écoutent les autres et construisent un petit projet musical.',
    'camp.card3.title': 'Expérience studio',
    'camp.card3.body': 'Le stage se déroule dans un vrai studio, avec une approche pratique et créative.',
    'camp.cta': 'Demander les disponibilités du stage',
    'camp.cta.note': 'Les groupes sont organisés selon l’âge, le niveau et les disponibilités des enfants.',
    'camp.pricing.title': 'Nos formules — stage d’été',
    'camp.pricing.lede': 'Choisissez la formule qui correspond le mieux à votre enfant. Places limitées en petit groupe, sur réservation.',
    'camp.offer.discovery.title': 'Découverte',
    'camp.offer.discovery.price': '110 CHF',
    'camp.offer.discovery.subPrice': '2 sessions / semaine',
    'camp.offer.discovery.desc': 'Pour essayer l’atelier et découvrir plusieurs instruments.',
    'camp.offer.discovery.cta': 'Demander la formule découverte',
    'camp.offer.progression.title': 'Progression',
    'camp.offer.progression.price': '150 CHF',
    'camp.offer.progression.subPrice': '3 sessions / semaine',
    'camp.offer.progression.desc': 'Pour approfondir l’expérience musicale sur plusieurs jours.',
    'camp.offer.progression.cta': 'Choisir la formule progression',
    'camp.offer.immersion.title': 'Immersion',
    'camp.offer.immersion.price': '220 CHF',
    'camp.offer.immersion.subPrice': '5 sessions / semaine',
    'camp.offer.immersion.desc': 'Pour vivre une semaine complète de musique, de jeu en groupe et de création.',
    'camp.offer.immersion.cta': 'Choisir la formule immersion',
    ...
    'individual.offer.discovery.cta': 'Réserver une séance découverte — 55 CHF',
    'individual.offer.monthly.tag': '⚡ Flexible',
    'individual.offer.monthly.title': 'Formule mensuelle flexible',
    'individual.offer.monthly.price': '95 CHF / séance',
    'individual.offer.monthly.subPrice': 'Montant selon les séances confirmées',
    'individual.offer.monthly.cta': 'Choisir la formule mensuelle',
    'individual.offer.annual.tag': '🧭 Continuité pédagogique',
    'individual.offer.annual.title': 'Inscription régulière',
    'individual.offer.annual.price': '85 CHF / séance',
    'individual.offer.annual.subPrice': 'Engagement année scolaire',
    'individual.offer.annual.cta': 'Choisir l’inscription régulière',

    // Videos eleves
    'videos.eyebrow': 'Élèves en studio',
    'videos.title': 'Vidéos des élèves',
    'videos.lede': 'Des interprétations et enregistrements réalisés par les élèves : une trace concrète du travail, de la progression et de l’expression de chacun.',
    'videos.itemTitle': 'Projet d’élève enregistré en studio',
    ...
    'footer.nav.lecons': 'Cours de musique',
    ...
    'footer.students.body': 'Votre créneau est déjà confirmé ? Réglez votre formule mensuelle, annuelle ou mettez en place le paiement automatique.',
    ...
    // Régler ma formule block (lecons page)
    'lecons.regler.title': 'Déjà inscrit ? Régler votre formule',
    'lecons.regler.body': 'Si votre créneau hebdomadaire a déjà été confirmé avec le studio, vous pouvez régler votre formule mensuelle, mettre en place un paiement automatique ou choisir un paiement annuel.',
    'lecons.regler.cta': 'Régler ma formule',
    'lecons.regler.note': 'Les formules régulières sont mises en place après confirmation du créneau avec le studio.',
  ...
  en: {
    ...
    'nav.branch.music.kicker': 'MUSIC',
    'nav.branch.music.label': 'Music lessons',
    'nav.branch.av.kicker': 'AUDIOVISUAL',
    'nav.branch.av.label': 'Recording / streaming',
    'nav.branch.acoustic.kicker': 'ACOUSTICS',
    'nav.branch.acoustic.label': 'Soundproofing / treatment',
    ...
    'nav.openLecons': 'Open Music lessons menu',
    ...
    'lecons.hero.lede': 'A structured, personalised approach shaped around each student’s tastes, pace and goals — to learn, create and find their own voice.',
    ...
    'group.cta': 'Request a free trial lesson on WhatsApp',
    'group.cta.note': 'We’ll propose the slot that best matches your child’s age, level and the available groups.',
    'group.pricing.title': 'Our plans — group lessons',
    'group.pricing.lede': 'Clear plans designed around your child’s calendar and a consistent learning path.',
    'group.pricing.note': 'Regular plans are set up after confirming the weekly slot with the studio.',
    'group.offer.trial.tag': '🎶✨',
    'group.offer.trial.title': 'Free trial lesson',
    'group.offer.trial.price': '0 CHF',
    'group.offer.trial.cta': 'Request a free trial lesson',
    'group.offer.monthly.tag': '👧👦',
    'group.offer.monthly.title': 'Flexible monthly plan',
    'group.offer.monthly.price': '70 CHF / session',
    'group.offer.monthly.subPrice': 'Total based on confirmed sessions',
    'group.offer.monthly.cta': 'Choose the monthly plan',
    'group.offer.annual.tag': '🧭 Learning continuity',
    'group.offer.annual.title': 'Regular enrolment',
    'group.offer.annual.price': '60 CHF / session',
    'group.offer.annual.subPrice': 'School-year commitment',
    'group.offer.annual.cta': 'Choose regular enrolment',

    // Summer camp (holiday version of the group workshop)
    'camp.badge': 'Holiday camp · Kids',
    'camp.title': 'Multi-instrument summer camp',
    'camp.card1.title': 'Several instruments',
    'camp.card1.body': 'Kids rotate instruments and develop an overall feel for music.',
    'camp.card2.title': 'Group creation',
    'camp.card2.body': 'They play together, listen to each other and build a small musical project.',
    'camp.card3.title': 'Studio experience',
    'camp.card3.body': 'The camp takes place in a real studio, with a hands-on, creative approach.',
    'camp.cta': 'Ask about camp availability',
    'camp.cta.note': 'Groups are organised by age, level and the children’s availability.',
    'camp.pricing.title': 'Our plans — summer camp',
    'camp.pricing.lede': 'Pick the plan that fits your child best. Limited spots in small groups, by reservation.',
    'camp.offer.discovery.title': 'Discovery',
    'camp.offer.discovery.price': '110 CHF',
    'camp.offer.discovery.subPrice': '2 sessions / week',
    'camp.offer.discovery.desc': 'To try the workshop and discover several instruments.',
    'camp.offer.discovery.cta': 'Ask about the Discovery plan',
    'camp.offer.progression.title': 'Progression',
    'camp.offer.progression.price': '150 CHF',
    'camp.offer.progression.subPrice': '3 sessions / week',
    'camp.offer.progression.desc': 'To go deeper into the musical experience over several days.',
    'camp.offer.progression.cta': 'Choose the Progression plan',
    'camp.offer.immersion.title': 'Immersion',
    'camp.offer.immersion.price': '220 CHF',
    'camp.offer.immersion.subPrice': '5 sessions / week',
    'camp.offer.immersion.desc': 'A full week of music, group playing and creation.',
    'camp.offer.immersion.cta': 'Choose the Immersion plan',
    ...
    'individual.offer.discovery.price': '55 CHF',
    'individual.offer.discovery.cta': 'Book a discovery session — 55 CHF',
    'individual.offer.monthly.tag': '⚡ Flexible',
    'individual.offer.monthly.title': 'Flexible monthly plan',
    'individual.offer.monthly.price': '95 CHF / session',
    'individual.offer.monthly.subPrice': 'Total based on confirmed sessions',
    'individual.offer.monthly.cta': 'Choose the monthly plan',
    'individual.offer.annual.tag': '🧭 Learning continuity',
    'individual.offer.annual.title': 'Regular enrolment',
    'individual.offer.annual.price': '85 CHF / session',
    'individual.offer.annual.subPrice': 'School-year commitment',
    'individual.offer.annual.cta': 'Choose regular enrolment',

    // Videos eleves
    'videos.eyebrow': 'Students in studio',
    'videos.title': 'Student videos',
    'videos.lede': 'Performances and recordings made by our students: tangible evidence of their work, progress and individual expression.',
    'videos.itemTitle': 'Student project recorded in the studio',
    ...
    'footer.nav.lecons': 'Music lessons',
    'footer.nav.regler': 'Settle my plan',
    'footer.nav.prise': 'Recording studio',
    'footer.nav.about': 'About',
    'footer.nav.contact': 'Contact',
    'footer.students.title': 'Already enrolled students',
    'footer.students.body': 'Is your slot already confirmed? Settle your monthly or annual plan, or set up automatic payment.',
    'footer.students.cta': 'Settle my plan',
    ...
    // Régler ma formule block (lecons page)
    'lecons.regler.title': 'Already enrolled? Settle your plan',
    'lecons.regler.body': 'If your weekly slot has already been confirmed with the studio, you can settle your monthly plan, set up automatic payment or choose an annual payment.',
    'lecons.regler.cta': 'Settle my plan',
    'lecons.regler.note': 'Regular plans are set up after the slot has been confirmed with the studio.',
  ...
  es: {
    ...
    'nav.branch.music.kicker': 'MÚSICA',
    'nav.branch.music.label': 'Clases de música',
    'nav.branch.av.kicker': 'AUDIOVISUAL',
    'nav.branch.av.label': 'Grabación / streaming',
    'nav.branch.acoustic.kicker': 'ACÚSTICA',
    'nav.branch.acoustic.label': 'Insonorización / tratamiento',
    ...
    'nav.openLecons': 'Abrir el menú Clases de música',
    ...
    'lecons.hero.title': 'Clases de música en Cologny / Ginebra',
    'lecons.hero.lede': 'Un enfoque estructurado y personalizado, adaptado a los gustos, el ritmo y los objetivos de cada alumno, para aprender, crear y encontrar su propia voz.',
    ...
    'group.cta': 'Solicitar una clase de prueba gratuita por WhatsApp',
    'group.cta.note': 'Le propondremos el horario más adecuado según la edad del niño, su nivel y los grupos disponibles.',
    'group.pricing.title': 'Nuestros planes — clases en grupo',
    'group.pricing.lede': 'Fórmulas claras que se adaptan al calendario de su hijo/a y a la continuidad de su recorrido.',
    'group.pricing.note': 'Los planes regulares se activan tras confirmar el horario semanal con el estudio.',
    'group.offer.trial.tag': '🎶✨',
    'group.offer.trial.title': 'Clase de prueba gratuita',
    'group.offer.trial.price': '0 CHF',
    'group.offer.trial.cta': 'Solicitar una clase de prueba gratuita',
    'group.offer.monthly.tag': '👧👦',
    'group.offer.monthly.title': 'Plan mensual flexible',
    'group.offer.monthly.price': '70 CHF / sesión',
    'group.offer.monthly.subPrice': 'Importe según las sesiones confirmadas',
    'group.offer.monthly.cta': 'Elegir el plan mensual',
    'group.offer.annual.tag': '🧭 Continuidad pedagógica',
    'group.offer.annual.title': 'Inscripción regular',
    'group.offer.annual.price': '60 CHF / sesión',
    'group.offer.annual.subPrice': 'Compromiso durante el año escolar',
    'group.offer.annual.cta': 'Elegir la inscripción regular',

    // Summer camp (holiday version of the group workshop)
    'camp.badge': 'Campamento de vacaciones · Niños',
    'camp.title': 'Campamento de verano multi-instrumental',
    'camp.card1.title': 'Varios instrumentos',
    'camp.card1.body': 'Los niños cambian de instrumento y desarrollan una visión global de la música.',
    'camp.card2.title': 'Creación en grupo',
    'camp.card2.body': 'Tocan juntos, se escuchan y construyen un pequeño proyecto musical.',
    'camp.card3.title': 'Experiencia de estudio',
    'camp.card3.body': 'El campamento se realiza en un verdadero estudio, con un enfoque práctico y creativo.',
    'camp.cta': 'Consultar disponibilidad del campamento',
    'camp.cta.note': 'Los grupos se organizan según la edad, el nivel y la disponibilidad de los niños.',
    'camp.pricing.title': 'Nuestros planes — campamento de verano',
    'camp.pricing.lede': 'Elige el plan que mejor se adapte a tu hijo. Plazas limitadas en grupos pequeños, con reserva.',
    'camp.offer.discovery.title': 'Descubrimiento',
    'camp.offer.discovery.price': '110 CHF',
    'camp.offer.discovery.subPrice': '2 sesiones / semana',
    'camp.offer.discovery.desc': 'Para probar el taller y descubrir varios instrumentos.',
    'camp.offer.discovery.cta': 'Consultar el plan Descubrimiento',
    'camp.offer.progression.title': 'Progresión',
    'camp.offer.progression.price': '150 CHF',
    'camp.offer.progression.subPrice': '3 sesiones / semana',
    'camp.offer.progression.desc': 'Para profundizar la experiencia musical durante varios días.',
    'camp.offer.progression.cta': 'Elegir el plan Progresión',
    'camp.offer.immersion.title': 'Inmersión',
    'camp.offer.immersion.price': '220 CHF',
    'camp.offer.immersion.subPrice': '5 sesiones / semana',
    'camp.offer.immersion.desc': 'Para vivir una semana completa de música, juego en grupo y creación.',
    'camp.offer.immersion.cta': 'Elegir el plan Inmersión',
    ...
    'individual.offer.discovery.price': '55 CHF',
    'individual.offer.discovery.cta': 'Reservar una sesión de descubrimiento — 55 CHF',
    'individual.offer.monthly.tag': '⚡ Flexible',
    'individual.offer.monthly.title': 'Plan mensual flexible',
    'individual.offer.monthly.price': '95 CHF / sesión',
    'individual.offer.monthly.subPrice': 'Importe según las sesiones confirmadas',
    'individual.offer.monthly.cta': 'Elegir el plan mensual',
    'individual.offer.annual.tag': '🧭 Continuidad pedagógica',
    'individual.offer.annual.title': 'Inscripción regular',
    'individual.offer.annual.price': '85 CHF / sesión',
    'individual.offer.annual.subPrice': 'Compromiso durante el año escolar',
    'individual.offer.annual.cta': 'Elegir la inscripción regular',

    // Videos eleves
    'videos.eyebrow': 'Alumnos en estudio',
    'videos.title': 'Videos de los alumnos',
    'videos.lede': 'Interpretaciones y grabaciones realizadas por los alumnos: una muestra concreta de su trabajo, su progreso y su expresión personal.',
    'videos.itemTitle': 'Proyecto de alumno grabado en el estudio',
    ...
    'footer.nav.lecons': 'Clases de música',
    ...
    'footer.students.body': '¿Su horario ya está confirmado? Pague su plan mensual o anual, o configure el pago automático.',
    ...
    // Régler ma formule block (lecons page)
    'lecons.regler.title': '¿Ya está inscrito? Pague su plan',
    'lecons.regler.body': 'Si su horario semanal ya ha sido confirmado con el estudio, puede pagar su plan mensual, configurar el pago automático o elegir un pago anual.',
    'lecons.regler.cta': 'Pagar mi plan',
    'lecons.regler.note': 'Los planes regulares se establecen tras la confirmación del horario con el estudio.',
  ...
  it: {
    ...
    'nav.branch.music.kicker': 'MUSICA',
    'nav.branch.music.label': 'Lezioni di musica',
    'nav.branch.av.kicker': 'AUDIOVISIVO',
    'nav.branch.av.label': 'Registrazione / streaming',
    'nav.branch.acoustic.kicker': 'ACUSTICA',
    'nav.branch.acoustic.label': 'Insonorizzazione / trattamento',
    ...
    'nav.openLecons': 'Apri il menu Lezioni di musica',
    ...
    'lecons.hero.title': 'Corsi di musica a Cologny / Ginevra',
    'lecons.hero.lede': 'Un approccio strutturato e personalizzato, adattato ai gusti, al ritmo e agli obiettivi di ogni allievo, per imparare, creare e trovare la propria voce.',
    ...
    'group.title': 'Il laboratorio multi-strumentale',
    ...
    'group.cta': 'Richiedere una lezione di prova gratuita su WhatsApp',
    'group.cta.note': 'Le proporremo l’orario più adatto in base all’età del bambino, al suo livello e ai gruppi disponibili.',
    'group.pricing.title': 'I nostri piani — lezioni di gruppo',
    'group.pricing.lede': 'Formule chiare, pensate per adattarsi al calendario di suo figlio/a e alla continuità del percorso.',
    'group.pricing.note': 'I piani regolari vengono attivati dopo la conferma dell’orario settimanale con lo studio.',
    'group.offer.trial.tag': '🎶✨',
    'group.offer.trial.title': 'Lezione di prova gratuita',
    'group.offer.trial.price': '0 CHF',
    'group.offer.trial.cta': 'Richiedere una lezione di prova gratuita',
    'group.offer.monthly.tag': '👧👦',
    'group.offer.monthly.title': 'Piano mensile flessibile',
    'group.offer.monthly.price': '70 CHF / sessione',
    'group.offer.monthly.subPrice': 'Importo in base alle sessioni confermate',
    'group.offer.monthly.cta': 'Scegli il piano mensile',
    'group.offer.annual.tag': '🧭 Continuità didattica',
    'group.offer.annual.title': 'Iscrizione regolare',
    'group.offer.annual.price': '60 CHF / sessione',
    'group.offer.annual.subPrice': 'Impegno per l’anno scolastico',
    'group.offer.annual.cta': 'Scegli l’iscrizione regolare',

    // Summer camp (holiday version of the group workshop)
    'camp.badge': 'Camp vacanze · Bambini',
    'camp.title': 'Campo estivo multi-strumentale',
    'camp.card1.title': 'Più strumenti',
    'camp.card1.body': 'I bambini cambiano strumento e sviluppano una visione globale della musica.',
    'camp.card2.title': 'Creazione in gruppo',
    'camp.card2.body': 'Suonano insieme, si ascoltano e costruiscono un piccolo progetto musicale.',
    'camp.card3.title': 'Esperienza in studio',
    'camp.card3.body': 'Il camp si svolge in un vero studio, con un approccio pratico e creativo.',
    'camp.cta': 'Chiedi la disponibilità del camp',
    'camp.cta.note': 'I gruppi sono organizzati in base all’età, al livello e alla disponibilità dei bambini.',
    'camp.pricing.title': 'I nostri piani — campo estivo',
    'camp.pricing.lede': 'Scegli il piano più adatto a tuo figlio. Posti limitati in piccoli gruppi, su prenotazione.',
    'camp.offer.discovery.title': 'Scoperta',
    'camp.offer.discovery.price': '110 CHF',
    'camp.offer.discovery.subPrice': '2 sessioni / settimana',
    'camp.offer.discovery.desc': 'Per provare il laboratorio e scoprire più strumenti.',
    'camp.offer.discovery.cta': 'Chiedi il piano Scoperta',
    'camp.offer.progression.title': 'Progressione',
    'camp.offer.progression.price': '150 CHF',
    'camp.offer.progression.subPrice': '3 sessioni / settimana',
    'camp.offer.progression.desc': 'Per approfondire l’esperienza musicale su più giorni.',
    'camp.offer.progression.cta': 'Scegli il piano Progressione',
    'camp.offer.immersion.title': 'Immersione',
    'camp.offer.immersion.price': '220 CHF',
    'camp.offer.immersion.subPrice': '5 sessioni / settimana',
    'camp.offer.immersion.desc': 'Per vivere una settimana intera di musica, gioco di gruppo e creazione.',
    'camp.offer.immersion.cta': 'Scegli il piano Immersione',
    ...
    'individual.offer.discovery.title': 'Sessione di scoperta',
    'individual.offer.discovery.price': '55 CHF',
    'individual.offer.discovery.cta': 'Prenota una sessione di scoperta — 55 CHF',
    'individual.offer.monthly.tag': '⚡ Flessibile',
    'individual.offer.monthly.title': 'Piano mensile flessibile',
    'individual.offer.monthly.price': '95 CHF / sessione',
    'individual.offer.monthly.subPrice': 'Importo in base alle sessioni confermate',
    'individual.offer.monthly.cta': 'Scegli il piano mensile',
    'individual.offer.annual.tag': '🧭 Continuità didattica',
    'individual.offer.annual.title': 'Iscrizione regolare',
    'individual.offer.annual.price': '85 CHF / sessione',
    'individual.offer.annual.subPrice': 'Impegno per l’anno scolastico',
    'individual.offer.annual.cta': 'Scegli l’iscrizione regolare',

    // Videos eleves
    'videos.eyebrow': 'Allievi in studio',
    'videos.title': 'Video degli allievi',
    'videos.lede': 'Interpretazioni e registrazioni realizzate dagli allievi: una testimonianza concreta del lavoro, dei progressi e dell’espressione personale.',
    'videos.itemTitle': 'Progetto di un allievo registrato in studio',
    ...
    'footer.nav.home': 'Home',
    'footer.nav.lecons': 'Corsi di musica',
    'footer.nav.regler': 'Pagare il mio piano',
    ...
    'footer.students.body': 'Il suo orario è già confermato? Paghi il piano mensile o annuale, oppure imposti il pagamento automatico.',
    'footer.students.cta': 'Pagare il mio piano',
    ...
    // Régler ma formule block (lecons page)
    'lecons.regler.title': 'Già iscritto? Paghi il suo piano',
    'lecons.regler.body': 'Se il suo orario settimanale è già stato confermato con lo studio, può pagare il piano mensile, impostare il pagamento automatico o scegliere un pagamento annuale.',
    'lecons.regler.cta': 'Pagare il mio piano',
    'lecons.regler.note': 'I piani regolari vengono attivati dopo la conferma dell’orario con lo studio.',
